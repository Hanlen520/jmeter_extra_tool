...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println(aaaaa); System.out.println(RSA.pubKeyDecrypt(aaaaa,
		 * "C:\\Users\\FCD\\Desktop\\key"));
		 * 
		 * 
		 * String bbbbb = RSA.pubKeyEncrypt("bbbbb", "C:\\Users\\FCD\\Desktop\\key");
		 * System.out.println(bbbbb); System.out.println(RSA.priKeyDecrypt(bbbbb,
		 * "C:\\Users\\FCD\\Desktop\\key"));
		 */
